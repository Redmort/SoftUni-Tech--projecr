...
public class CommentController {
    ...
    @PostMapping("/admin/censora/comment/{id}")
    @PreAuthorize("isAuthenticated()")
    public String censored (CommentBindingModel commentBindingModel, @PathVariable Integer id){
        if (!this.commentRepository.exists(id)){
            return "redirect:/";
        }
        ...
        String statusId = "0";
        statusId = commentBindingModel.getStatusId();
        String status = " ";
