...
public class ArticleController {
    ...
    public String details(Model model, @PathVariable Integer id) {
        ...
        //Article article = this.commentRepository.findOne(id).getArticle();

        Article article = this.articleRepository.findOne(id);
        //Set<Comment> comments = article.getComments();
        List<Comment> comments = new ArrayList<>();
        LinkedHashMap<Integer, List<Reply>> replies = new LinkedHashMap<>();
        ...
        for (Comment comment : article.getComments()){
            ...
            replies.put(comment.getId(), replyList);
        ...
        boolean commentsExist = !comments.isEmpty();

        model.addAttribute("replies", replies);
        model.addAttribute("commentExist", commentsExist);
